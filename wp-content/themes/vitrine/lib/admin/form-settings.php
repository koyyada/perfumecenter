...
function epico_admin_get_defaults()
{
	...
	$woocomerceSettingsPanel = array(
        ...
        'sections' => array(
            ...
            'category-description-position' => array(
	            'title'   => esc_html__('Category Description Position', 'vitrine'),
	            'tooltip' => esc_html__('You can manage the position of categories description with this option', 'vitrine'),
	            'fields'  => array(
		            'category-description-position' => array(
			            'type'   => 'switch',
			            'state0' => esc_html__('After The Header', 'vitrine'),
			            'state1' => esc_html__('On The Header', 'vitrine'),
			            'value'  => 1,
			            'default' => 1
		            )
	            )
