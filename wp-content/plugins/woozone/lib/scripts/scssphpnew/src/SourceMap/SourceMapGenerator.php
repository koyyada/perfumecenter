...
class SourceMapGenerator
{
    ...
    protected function normalizeFilename($filename)
    {
        ...
        $rootpath = isset($this->options['sourceMapRootpath']) ? $this->options['sourceMapRootpath'] : '';
        $basePath = isset($this->options['sourceMapBasepath']) ? $this->options['sourceMapBasepath'] : '';

        // "Trim" the 'sourceMapBasepath' from the output filename.
        if ( !empty($basePath) && strpos($filename, $basePath) === 0) {
