...
class Epico_Importer{
    ...
    private $demos = array("demo1","demo2","demo3","demo4","demo5","demo7","demo8","demo9","demo10","demo11","demo12","demo13","demo14","demo15","demo16","demo17","demo18","demo19","demo20","demo22","demo23","demo24","demo25","demo26","demo27","demo28","demo29","demo30","demo31","demo32","demo33","demo34","demo35","demo36","demo37","dokanvendor");
    ...
    function importRevSlider($demo_name )
    {
		...
		$import_rev_slid = $import_path ."revsld.zip";
		...
		if(is_file($import_rev_slid))
        {
            if(class_exists('RevSlider'))
            {
                $slider = new RevSlider();
                $response = $slider->importSliderFromPost(true, true, $import_rev_slid);
                echo  esc_html(" Done", 'vitrine') . "</p>";
            }
            else
            {
        ...
        <div id="ep-importer-box">
            ...
            <div id="demo-container">
               ...
               <!--demo 8 -->
				...
				<div class="demo">
                    <div class="description">
                        <h3 class="demo-name">Demo 37</h3>
                        <p>Multi page</p>
                        <a target="_blank" href="#" class="button import" data-demo="demo37"><?php esc_html_e('Import' , 'vitrine'); ?></a>
                        <a target="_blank" href="http://www.epicomedia.com/vitrine-demo37" class="button"><?php esc_html_e('Preview' , 'vitrine'); ?></a>
                    </div>
                    <div class="overlay"></div>
                    
                    <img src="<?php echo EPICO_THEME_LIB_URI; ?>/admin/dummydata/img/demo37.jpg" />  
                </div>
				<div class="demo">
                    <div class="description">
                        <h3 class="demo-name">dokanvendor</h3>
                        <p>Multi page</p>
                        <a target="_blank" href="#" class="button import" data-demo="dokanvendor"><?php esc_html_e('Import' , 'vitrine'); ?></a>
                        <a target="_blank" href="http://dokanvendors.epicomedia.com/" class="button"><?php esc_html_e('Preview' , 'vitrine'); ?></a>
                    </div>
                    <div class="overlay"></div>
                    
                    <img src="<?php echo EPICO_THEME_LIB_URI; ?>/admin/dummydata/img/dokanvendor.jpg" />  
                </div>
