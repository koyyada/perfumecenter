<?php
	...
	$amz_country = $this->WooZone_amazon_countries( 'country' );
	$amz_main_aff_id = $this->WooZone_amazon_countries( 'main_aff_id' );
?>
			<!-- StartSetup -->
			<div class="wz-setup">
				...
				<div class="wz-message">
					...
					<div class="alert alert-danger" role="alert"><?php echo sprintf( __('If you are using the aateam demo keys, you can test out and import up to %d products.', $this->localizationName), $this->the_plugin->ss['max_products_demo_keys'] ); ?>
						<a href="<?php echo admin_url("admin.php?page=WooZone_insane_import"); ?>" target="_blank"><?php _e('Go to Insane Import Module', $this->localizationName); ?></a>
					</div>
				</div>
				...
				<div class="wz-checkamazon">
			 		<a href="#" class="WooZoneWizardCheckAmzKeys"><?php _e('Check Amazon AWS Keys', $this->localizationName); ?></a>
		 		</div>
			</div>