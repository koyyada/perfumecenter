    ...
    VitrineTheme.prototype = {
        ...
        woocommerce_variation_attributes: function () {
            ...
            $attr_slides.on('click', function () {
                ...
                var $term_title = $(".variations.title_display .swiper-slide.selected").attr('title');
                ...
                $attr_container.closest('.value').siblings('span.image-label').find('span.attr-value').html($term_title);
            });
