...
$WooZone_search_params['Sort']['orig-rel-date'] = "Original Release date: newer to older";
$WooZone_search_params['Sort']['-orig-rel-date'] = "Original Release date: older to newer";
...
$WooZone_search_params['Sort']['-video-release-date'] = "Video Release date: newer to older";
