...
function WooZone_IM_options_cache( $action='default', $istab = '', $is_subtab='' ) {
    global $WooZone;
...
<div class="WooZone-form-row WooZone-im-cache <?php echo ($istab!='' ? ' '.$istab : ''); ?><?php echo ($is_subtab!='' ? ' '.$is_subtab : ''); ?>">
    ...
    <div class="WooZone-form-item large">
        <span style="margin:0px 0px 0px 10px" class="response"><?php echo WooZone_IM_options_cache( 'getStatus' ); ?></span><br />
    ...
    $tryed_module['db_alias'] => array(
        ...
        'insane_import' => array(
            ...
            'elements' => array(
				...
				'__cache' => array(
					'type' => 'html',
					'html' => WooZone_IM_options_cache( 'default', '__tab1', '' )
				),
