...
<div class="subcontainer" data-step_pms='<?php echo json_encode( $stepPms ); ?>'>
	...
	<div class="wz-notice wz-requirements-back">
		...
		<a href="#" title="Go back to WooZone Wizard">
	...
	<div class="row">
		 <div class="col-lg-12">
		 	<div class="wz-header" >
		 		...
		 		<h1><?php _e('Congrats! You have successfully set up WooZone Wizard!', $this->localizationName); ?>
		 			<i class="wz-icon"></i>
		 		</h1>
		 	...
		 	<form class="wz-main-form" id="wz-main-form" method="POST" action="<?php echo $nextprev['next']['url']; ?>">
				<?php if (function_exists('wp_nonce_field')) { wp_nonce_field('woozone-wizard-save', '_wz_nonce'); } ?>
